...
class Putdatatest(controllers.Rest):
    @view(format='json')
    def GET(self):
        print('in putdatatest controller')
        ...
        print('Not inserting data')
        return {'userName':userName,'password':password,'deviceID':deviceID,'temperature':temperature,'humidity':humidity}
